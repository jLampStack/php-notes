...
<body>
  ...
  <!-- <input id="colorInput" type="text" placeholder="Background Color: HEX, RGB, CMYK"><BR><BR> -->
  <input id="colorInput" type="color" placeholder="Background Color: HEX, RGB, CMYK"><BR><BR>
  ...
  <script>
    ...
    // Change background color of <ul> list 
    document.getElementById('colorInput').addEventListener( 'change', (e) => {
      const colorValue = document.getElementById('colorInput').value;
      const listBackground = document.getElementById('listBackground');
      if(listBackground !== '' && listBackground !== undefined && listBackground !== null) {
        listBackground.style.backgroundColor = colorValue;
      } 
    });
